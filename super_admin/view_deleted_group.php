...
<!-- 
      ...
      <Form name="multiple_files" method="post" action="download_delete_process/deletedGroups_delDown.php">
    <!-- Heading -->
    <hr>
    <div class="">
        <table id="dtable" class="table table-striped">
            ...
            <tbody>
                    ...
                    <div class="">
                        ...
                        <button type="submit" class="btn btn-danger" name="delete"><i class="fa fa-trash"></i> Delete Folders</button>
                        <button type="submit" class="btn btn-primary" name="download"><i class="fa fa-download"></i> Download Folders</button>
                    </div>
                                <?php 
                  ...
                  $query = mysqli_query($conn,"SELECT * FROM `archive_group_folder`") or die (mysqli_error($con));
