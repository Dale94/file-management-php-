...
<?php
         require_once("include/connection.php");
            ...
            $query="SELECT * FROM group_names where creator != 'NONE'";
            $result=mysqli_query($conn,$query);
            while($rs=mysqli_fetch_array($result)){
              $name =  $rs['group_name'];

              $files_q = "SELECT * FROM archive_group_files where group_name='$name'";
              $files_result = mysqli_query($conn, $files_q);
              $t_files = mysqli_num_rows($files_result);
           ?>       
          ?>       
          <a href="show_group_files.php?group_name=<?php echo $name; ?>">
          <div class="card">
              <div class="card-body">
                  <?php echo $name; ?>
                  <br>
