...
<?php
         require_once("include/connection.php");
            ...
            while($rs=mysqli_fetch_array($result)){
              ...
              $files_q = "SELECT * FROM archived_files where department='$id' and admin_status = 'Employee'";
              $files_result = mysqli_query($conn, $files_q);
              $t_files = mysqli_num_rows($files_result);
           ?>       
           <a href="view_admin_archive_department.php?department=<?php echo $name; ?>">
           <div class="card">
               <div class="card-body">
                   <?php echo $name; ?>
                   <br>
                   Deleted files: <?php echo $t_files?>
               </div>
           </div></a>
           <br>
