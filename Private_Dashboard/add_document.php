...
<tbody>
    ...
    <tr>
      ...
      $query = mysqli_query($conn,"SELECT DISTINCT ID,NAME,SIZE,EMAIL,ADMIN_STATUS,TIMERS,DOWNLOAD FROM upload_files WHERE NAME != 'EMPTY' AND department = '$department' AND archived = 'No'  group by NAME DESC") or die (mysqli_error($con));
