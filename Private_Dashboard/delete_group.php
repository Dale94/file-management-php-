<?php
 ...
 if(isset($_POST['delete']))
 {
    ...
    if (empty($multi_id)) {
        ...
        header('location: view_group_detail.php?group_name=' . $encoded_hashed_group_name);
        exit;
    }
            ...
            if (file_exists($dir . '/' . $file_name)) {
                ...
                if (rename($dir . '/' . $file_name, $archiveFolder . '/' . $new_file_name)) {
                    ...
                    if (mysqli_query($conn, $sql)) {
                        ...
                        echo '<script>alert("File archived successfully!"); window.location = "view_group_detail.php?group_name=' . $encoded_hashed_group_name . '";</script>';
                    } else {
                        echo '<script>alert("Error: ' . mysqli_error($conn) . '"); window.location = "view_group_detail.php?group_name=' . $encoded_hashed_group_name . '";</script>'; // Handle SQL insert error
                    }
                } else {
                    echo '<script>alert("Failed to move file to archive folder!"); window.location = "view_group_detail.php?group_name=' . $encoded_hashed_group_name . '";</script>';
                }
            } else {
                echo '<script>alert("File ' . $file_name . ' not found in directory!"); window.location = "view_group_detail.php?group_name=' . $encoded_hashed_group_name . '";</script>';
            }
        } else {
            echo '<script>alert("File record not found or Files not yours!"); window.location = "view_group_detail.php?group_name=' . $encoded_hashed_group_name . '";</script>';
        }
    }
 ...
 }else if(isset($_POST['download']))
 {
    ...
    if (empty($_POST['checkbox'])) {
        echo '<script>alert("Please select files to download!"); window.location = "view_group_detail.php?group_name=' . $encoded_hashed_group_name . '";</script>';
