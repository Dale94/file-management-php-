           ...
           $counter=mysqli_num_rows($query);
            ...
            if ($counter == 1) 
              { 
                ...
                alert("File '.$filename.' has already been uploaded by you.");
               ...
               ';
                ...
                if (move_uploaded_file($file, $destination)) {
                    $sql = "INSERT INTO upload_files (name, size, download, timers, admin_status, email, department, archived) VALUES ('$filename', $size, 0, '$time', 'Employee', '$user', '$department', 'No')";
